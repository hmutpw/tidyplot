...
```{r}
p1+theme_basic()+ scale_fill_manual(values = material.color.set(name = 'Discrete', brightness = 3))
```
...
```{r}
p1+theme_slope()+scale_fill_manual(values = material.color.set(name = 'Discrete', brightness = 3))
```
...
```{r}
p1+theme_clean()+scale_fill_manual(values = material.color.set(name = 'Discrete', brightness = 3))
```
...
p3 <- ggplot(data = mpg, aes(x = trans, y = displ, fill = factor(cyl)))+
  ...
  scale_fill_manual(values = material.color.set(name = 'Discrete', brightness = 3))+
  theme_slope()+
  facet_grid(.~year)
